...
export default function Searchbar({ onClick, onChange, onClear, inputValue }: SearchProp) {
  ...
  return (<>
    <div className="col-span-2 flex flex-row justify-between items-center w-full">
      ...
      <div onClick={onClear} className="dark:bg-gray-900 rounded-l-md dark:hover:bg-gray-700 bg-gray-200 cursor-pointer hover:bg-gray-400 h-12 flex justify-center items-center px-3">
